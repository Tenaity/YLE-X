...
extension DictionaryWord {
    ...
    static let sample = DictionaryWord(
        ...
        pronunciation: Pronunciation(
            british: PronunciationData(
                ipa: "/kæt/",
                audioUrl: "https://dictionary.cambridge.org/media/english/uk_pron/u/ukc/ukcat/ukcat_029.mp3",
                audioSource: "Cambridge"
            ),
            american: PronunciationData(
                ipa: "/kæt/",
                audioUrl: "https://dictionary.cambridge.org/media/english/us_pron/c/cat/cat__/cat.mp3",
                audioSource: "Cambridge"
            )
        ),
        examples: [
    ...
    static let samples: [DictionaryWord] = [
        ...
        DictionaryWord(
            ...
            definitionVi: "Một con vật được thuần hóa với bốn chân, thường được nuôi làm thú cưng.",
            pronunciation: Pronunciation(
                british: PronunciationData(ipa: "/dɒɡ/", audioUrl: "", audioSource: ""),
                american: PronunciationData(ipa: "/dɔːɡ/", audioUrl: "", audioSource: "")
            ),
            examples: [
                Example(level: "starters", sentenceEn: "I see a dog.", sentenceVi: "Em nhìn thấy con chó.")
            ],
            imageUrl: nil,
            emoji: "🐶",
            difficulty: 1,
